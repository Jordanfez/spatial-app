...
import ImageRapport from '../../img/ImageRapport5.png';
import ImageRapport3 from '../../img/ImageRapport6.png';

const DetailMarcherSPace = () => {
    return (
        <>
            <Header />
...
export default DetailMarcherSPace