...
import { fetchRaportindustriesFunction } from '../../services/GetFunction/GetAdmin/getAdminFunctions.js';
import { postRapport } from '../../services/Post/PostAdminFunction/postAdminFunction.js';
    ...
    const handleSubmit = async () => {
        if (nom === "") {
            ...
            try {
                ...
                const request = await postRapport(formData);
                        ...
                        >
                            <Fade in={open}>
                                <Box sx={style}>
                                    ...
                                    {showMessage === "sucess" ? (
                                        <Alert variant="filled" severity="success">Rapport creer avec success!</Alert>
                                    ) : responseStatus === 400 ? (
                                        ...
                                        <div className="col">
                                            ...
                                            >
                                                ...
                                                <OutlinedInput
                                                    ...
                                                    placeholder="Nouveauté sur l'édition..."
                                                />
                                            </FormControl>
                                        </div>
                                    </div>
